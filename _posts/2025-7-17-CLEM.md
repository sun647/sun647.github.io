...
---
# How to Change a Filter Cube in the Leica Cryo-CLEM System

1. Push down to open the filter cube cover above the objective lens.

2. Push the pin at the center to rotate the turret to the target filter cube position.

3. Replace the target filter cube with the desired filter cube.

4. Close all Leica software.

5. Open the **Leica Hardware Configuration** software.

6. Click **Configure**.

7. Click **IL-Turret**.

8. Select the filter cube slot that was replaced.

9. Find the name of the new filter cube in the list below and double-click it to assign it to the selected slot.

10. Save the configuration and restart the Leica software if necessary.
---
